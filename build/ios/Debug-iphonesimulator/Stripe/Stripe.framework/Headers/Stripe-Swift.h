...
@interface STPPaymentCardTextField : UIControl <UIKeyInput, UITextFieldDelegate>
/// :nodoc:
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
/// seealso:
...
@property (nonatomic) enum UINavigationItemLargeTitleDisplayMode largeTitleDisplayMode;
